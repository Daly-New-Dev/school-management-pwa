// A very basic service worker for PWA installation and minimal offline support.

const CACHE_NAME = 'school-admin-cache-v1';
const urlsToCache = [
  './',
  './index.html',
  './manifest.json',
...
const CACHE_NAME = 'school-admin-cache-v3'; // **IMPORTANT**: Increment this version number with each update.
const urlsToCache = [
  './',
  './index.html',
  './manifest.json',
